...
export const batch2 = [
 ...
 tasks:[task('① 物體在兩倍焦距外',{kind:'convex',f:10,u:30},'固定焦距10cm，比較物距30和40cm。像的位置與大小怎麼變？'),task('② 物體移到焦點內',{kind:'convex',f:10,u:5},'直接觀察像的方向與是否能投影，再和物距10cm比較。'),task('③ 換成凹透鏡',{kind:'concave',f:10,u:30},'保持物距，換成凹透鏡，觀察光線或反向延長線在哪裡相交。')],
 ...
 tasks:[task('① 頻率與波長',{mode:'travel',f:340,v:340,length:1},'只把頻率加倍，比較波長；注意聲速維持不變。'),task('② 開管基頻',{mode:'open',f:170,v:340,length:1},'固定長度1m，先觀察170Hz的狀態，再比較250Hz。'),task('③ 閉管與開管',{mode:'closed',f:85,v:340,length:1},'比較85、170、255Hz，不要假設所有整數倍都能共振。')],
 ...
 {
 id:'electromagnetism',noPrediction:true,title:'電磁鐵、馬達與發電機實驗室',subject:'理化',grade:'國中',unit:'電與磁',minutes:'20–25',prior:'電流、磁場、能量',
 ...
 tasks:[task('① 飽和與剩餘固體',{solute:'a',temperature:20,water:100,soluteMass:50},'先記錄剩餘固體，再只增加水量。'),task('② 加熱與冷卻',{solute:'a',temperature:60,water:100,soluteMass:50},'記錄60°C的已溶解量，再降到20°C。兩筆相差多少？'),task('③ 濃度不是加入量除以水量',{solute:'b',temperature:20,water:100,soluteMass:100},'比較加入溶質與真正溶解的質量，算濃度時分母是哪一個？')],
 ...
 {
 id:'moon-eclipse',noPrediction:true,title:'月相、日食與月食實驗室',subject:'地科',grade:'國中',unit:'天文',minutes:'15–20',prior:'日月地相對位置與光影',
 ...
 tasks:[task('① 朔不一定日食',{phase:0,node:90,inclination:5},'保持朔，把交點方向從90°改成0°，比較軌道偏離。'),task('② 望與月食',{phase:180,node:0,inclination:5},'先觀察望的位置，再把相位角改為90°比較。'),task('③ 沒有傾角的假想世界',{phase:0,node:90,inclination:0},'比較傾角0°和5°。為什麼現實不會每個朔望都發生食？')],
 formula:'可見亮面比例 k=(1−cosα)/2；軌道黃緯 β=asin(sin i × sin(α−Ω))。',
 limits:'圓軌道教學幾何；相位角近似黃經差，並非精密星曆。以離朔／望≤5°且|β|≤1°標記「食候選」，門檻只作教學，不能用來推算日期、食分、全食環食或地面可見地區。軌道俯視圖刻意放大天體，垂直偏離以讀值呈現。',
 ...
 {
 id:'seasons',noPrediction:true,title:'四季與太陽高度角實驗室',subject:'地科',grade:'國中',unit:'天文',minutes:'15–20',prior:'緯度、地軸、角度',
 ...
 {
 id:'plant-exchange',noPrediction:true,title:'呼吸作用、蒸散與氣孔實驗室',subject:'生物',grade:'國中',unit:'植物生理',minutes:'15–20',prior:'光合作用、呼吸作用、水分運輸',
 ...
 {
 id:'ecosystem',noPrediction:true,title:'生態系、食物網與族群實驗室',subject:'生物',grade:'國中',unit:'生態',minutes:'20–25',prior:'生產者、消費者、能量',
 ...
 tasks:[task('① 能量不是循環',{energy:10000,efficiency:10},'記錄每階層能量，再把傳遞比例調到20%；不要改成100%定律。'),task('② 接近承載量',{initial:50,capacity:200,rate:0.2,time:10},'記錄時間10和30，觀察族群曲線是否一直同速增加。'),task('③ 超出承載量',{initial:300,capacity:100,rate:0.2,time:10},'觀察N₀>K的結果。這是否能推算整個食物網的真實變化？')],
