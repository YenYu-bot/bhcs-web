export const singleFormExemptions = Object.freeze([
  ...
  {topic:'timestables',unit:'tables',singleForm:true,reason:'速度練習頁，題型即運算式版型'},
  {topic:'timestables',unit:'fill',singleForm:true,reason:'速度練習頁，題型即運算式版型'},
  {topic:'timestables',unit:'div',singleForm:true,reason:'速度練習頁，題型即運算式版型'},
  {topic:'timestables',unit:'rem',singleForm:true,reason:'速度練習頁，題型即運算式版型'},
  {topic:'timestables',unit:'mixed',singleForm:true,reason:'速度練習頁，題型即運算式版型'},
  {topic:'timestables',unit:'twodigit',singleForm:true,reason:'速度練習頁，題型即運算式版型'},
