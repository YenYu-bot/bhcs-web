...
|---|---:|
| topic / 組合 | 78 / 2517 |
| safeQuestion 抽樣 / 成功取題 | 503400 / 503400 |
| 通過 / 失敗 | 2517 / 0 |
| 候選 gen / null | 595151 / 67423 |
...
| speed / `meet` | 73.0% | 2 |
| numberline / `mark` | 81.4% | 6 |
| statistics / `mean` | 72.6% | 5 |
...
| similar / `sides` | 57.4% | 1 |
| similar / `aa` | 77.7% | 4 |
| similar / `area` | 51.0% | 1 |
| similar / `measure` | 76.3% | 1 |
| circle1 / `sector` | 59.0% | 1 |
